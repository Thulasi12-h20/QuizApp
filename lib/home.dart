...
import 'package:fullter_quiz/quizstar.dart';
...
class _homepageState extends State<homepage> {
  ...
  List<String> des = [
    ...
    "Flutter, being a statically typed programming language is very powerful and Fast.\nit's DMA feature makes it more useful. !",
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          customcard("Dart", images[3], des[3]),
