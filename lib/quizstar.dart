...
import 'package:fullter_quiz/resultpage.dart';
...
class getjson extends StatelessWidget {
  ...
  setasset() {
    if (langname == "Fullter") {
      assettoload = "assets/fultter.json";
...
class _quizpageState extends State<quizpage> {
  ...
  void checkanswer(String k) {
    ...
    if (mydata[2][i.toString()] == mydata[1][i.toString()][k]) {
      ...
      marks = marks + 1;
      // changing the color va  1riable to be green
      colortoshow = right;
    } else {
      // just a print sattement to check the correct working
  ...
  Widget choicebutton(String k) {
    return Padding(
      ...
      child: MaterialButton(
        ...
        child: Text(
          mydata[1][i.toString()][k]!=null? mydata[1][i.toString()][k]:'default value',
          style: TextStyle(
            color: Colors.white,
            fontFamily: "Alike",
            fontSize: 16.0,
